                    ...
                    <div class="col col-xl-10">
                        <div class="card" style="border-radius: 15px;">
                            ...
                            <div class="card-body p-5">
                                <h6 class="mb-3">Cadastrar novo usuário</h6>
                                <div class="container m-2"> 
                                    ...
                                    <form class="d-flex justify-content-center align-items-center mb-4" method="post">
                                        ...
                                        <%if (errors.get("e_userexist") != null) {
                                        %>
                                        <p style="color:#fc3a51"><%=errors.get("e_userexist")%></p>
                                        <%}%>
                                        <button type="submit" class="btn btn-dark btn-lg ms-2">Cadastrar</button>
                                    </form>
                                </div>
                            </div>                            
                        </div>
